...
namespace Dicionario\Format;

use Base\Format\AbstractFormatData;
use Doctrine\ORM\EntityManager;

class DicionarioFormatData extends AbstractFormatData 
{
    ...
    public function format(Array $data = array())
    {
        ...
        if (isset($_FILES['imagemCapa']) && $_FILES['imagemCapa']['tmp_name'] != ''){
            ...
            move_uploaded_file($_FILES['imagemCapa']['tmp_name'], getcwd().'/public/img/material/dicionario/'.$file);
        }
        ...
        $data['tipoid'] = $this->getEm()->getRepository('Material\Entity\Tipomaterial')->find(2);
        return $data;
    }
